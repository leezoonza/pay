...
class CustomerControllerTests {
    ...
    void signsUpCustomer() {
        MvcTestResult result = signup(new SignupRequest("김철수", "010-1234-5678", "verification-id"));
    ...
    void rejectsInvalidRequest() {
        MvcTestResult result = signup(new SignupRequest("김철수", "01012345678", "verification-id"));
    ...
    void rejectsMissingField() {
        MvcTestResult result = signup(new SignupRequest(null, "010-1234-5678", "verification-id"));
